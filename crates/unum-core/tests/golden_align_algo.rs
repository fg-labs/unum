...
fn record_align_stats_cases(golden: &mut Golden) {
    ...
    let align = [
        unum_core::align_algo::EDIT_MATCH,
        unum_core::align_algo::EDIT_MISMATCH,
        unum_core::align_algo::EDIT_INSERT,
    ];
...
/// A copy of [`unum_core::align_algo::global_alignment`]'s DP + traceback
...
fn global_alignment_flipped_tie_break(
    ...
    p: &[u8],
    band: i32,
) -> unum_core::align_algo::AlignResult {
    use unum_core::align_algo::{AlignResult, EDIT_DELETE, EDIT_INSERT, EDIT_MATCH, EDIT_MISMATCH};
