...
//! (`fg_t1k_core::refbuild::build_reference`) against the HLA subset fixture,
...
//! `crates/fg-t1k-core/src/refbuild/dat.rs`'s `drand48` module docs.

use fg_t1k_core::refbuild;
