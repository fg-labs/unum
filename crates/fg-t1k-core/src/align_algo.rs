...
//! (`crates/fg-t1k-sys/tests/diff_align_algo.rs`) asserts both.
//!
...
mod tests {
    ...
    /// oracle (`crates/fg-t1k-sys/tests/diff_align_algo.rs`'s
    ...
    /// against the real C++ oracle (`crates/fg-t1k-sys/tests/
    /// diff_align_algo.rs`'s `regression_traceback_usize_underflow_panic`):
